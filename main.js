...
var mats = [
  './assets/sukany.jpg', //those are strings with urls, for example: "https://threejs.org/examples/textures"/uv_grid_opengl.jpg
  './assets/Sukanya.jpeg',
  './assets/sukan.png',
  './assets/suku.png', //those are strings with urls, for example: "https://threejs.org/examples/textures"/uv_grid_opengl.png
  './assets/Suk.jpeg',
  './assets/su.png',
].map(pic => {
...
function moveCamera() {
  ...
  punk.rotation.x += 0.001;
  punk.rotation.y += 0.001;
